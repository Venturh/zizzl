...
function Login({
	session,
	csrfToken,
}: NextAuthOptions & { csrfToken: string }) {
	...
	return (
		<LandingLayout title={title} description={description}>
			<div className="w-full max-w-md pt-12 m-auto space-y-4">
				<div className="flex flex-col w-full max-w-sm p-3 mx-auto space-y-3 rounded-md shadow-sm dark:shadow-none bg-secondary ring ring-accent">
					...
					<div className="flex flex-col space-y-2">
						<Button onClick={() => signIn('github')} variant="accent">
						...
						<Button onClick={() => signIn('discord')} variant="accent">
							<div className="inline-flex space-x-4">
								<svg
									className="w-5 h-5"
									viewBox="0 0 71 71"
